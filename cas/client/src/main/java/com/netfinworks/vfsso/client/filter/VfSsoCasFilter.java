...
/**
 * 
 * <p>VFSSO Web filter</p>
 * @author huipeng
 * @version $Id: VfSSOFilter.java, v 0.1 Jun 3, 2014 6:46:43 PM knico Exp $
 */
public class VfSsoCasFilter implements Filter {
    ...
    public void doCasFilter(HttpServletRequest hsr, ServletResponse response, FilterChain chain)
        ...
        logger.info("Start SSO filter for url:{}, cookie token:{}", url, token);
